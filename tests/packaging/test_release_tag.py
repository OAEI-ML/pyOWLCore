...
def _project(tmp_path: Path, version: str = "0.1.1") -> Path:
...
def test_current_stable_tag_matches_exactly(tmp_path: Path) -> None:
    assert version_from_tag("v0.1.1", _project(tmp_path)) == "0.1.1"


@pytest.mark.parametrize(
    "tag",
    ["v0.1.1dev0", "v0.1.1.dev0", "0.1.1", "v0.1.1/../../main", "v0.1.1 dev0"],
)
