...
| [Packaging and release](../specs/packaging.md) | WP12 artifact/build/resolver/license/SBOM/provenance/publishing machinery | Generated evidence belongs under `reports/release/<version>/` | Active; no artifact publication, name control, legal approval, signing or reference-platform success is claimed |
| Documentation and API stabilization | WP13 curated guidance, executable examples, API snapshot and release tests | [API guide](api.md), [compatibility](compatibility.md), [release checklist](release-checklist.md) | Candidate API; explicit release-owner and consumer-owner approval remains required |
