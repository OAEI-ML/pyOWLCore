...
retained signature/identity/axiom-type index-construction checkpoints, 186
snapshot/document counter-record publication checkpoints, 42 retained
signature/identity/axiom-type layout/binding/size/page checkpoints, 13 native
index request/source/result Python-bridge checkpoints, and 39 canonical
validation, wire validation, and wire roundtrip Python-bridge checkpoints. It
covers 21,229 checkpoints locally; the remaining bridge, process-allocator,
